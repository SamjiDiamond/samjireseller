        ...
        Route::group(['middleware'=>'isActive'], function() {
            Route::middleware(['CheckStatus'])->group(function () {
                ...
                Route::post('2fa', 'UserController@submit2fa')->name('change.2fa');
                 ...
                 //Billpayment
                Route::get('airtime', 'BillsController@airtime')->name('user.airtime');
                Route::post('loadairtime', 'BillsController@loadairtime')->name('user.loadairtime');
                Route::get('internet', 'BillsController@internet')->name('user.internet');
                Route::get('internet/{id}', 'BillsController@selectinternet')->name('user.select.internet');
                Route::post('buydata/{id}', 'BillsController@buydata')->name('user.buydata');
                Route::get('cabletv', 'BillsController@cabletv')->name('user.cabletv');
                Route::post('cabletv', 'BillsController@validatecable')->name('user.select.cable');
                Route::get('cabletv-validated', 'BillsController@validateddecoder')->name('user.validated.cable');
                Route::post('cabletv-buy/{id}', 'BillsController@buytv')->name('user.buytv');
                Route::get('utilitybill', 'BillsController@utilitybill')->name('user.utilitybill');
                Route::post('validateutilitybill', 'BillsController@validateutilitybill')->name('user.validateutilitybill');
                Route::get('utilitybill-validated', 'BillsController@validatedutility')->name('user.validated.utility');
                Route::post('buypower-validated/{id}', 'BillsController@buypower')->name('user.buypower');

    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card bg-white">
          <div class="card-body">
            <div class="">
              <h3 class="">Pay {{$network->name}} Utility Bill</h3>
              <p class="mt-0 mb-5">Pay {{$network->name}} Utility Bill At The Cheapest And Most Affordable Rate</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header header-elements-inline">
            <h3 class="mb-0">Pay {{$network->name}} Utility Bill</h3>
          ...
          <div class="card-body">
              <form role="form" action="{{route('user.buypower',$meter)}}" method="post">
													 @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <div class="input-group">
                      ...
                      <input disabled  required value="{{$network->name}}" class="form-control" >
                       <input class="input" name="company" hidden value="{{$network->code}}" type="text" >
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">Meter Type</label>
                  <div class="col-lg-10">
                    <div class="input-group">
                      <span class="input-group-prepend">
                        <span class="input-group-text"><i class="fa fa-fax"></i></span>
                       ...
                       @if($type == '01')
                                                                    <input class="form-control"   disabled value="Prepaid" required type="text" >
                                                                    <input hidden="true" name="type" value="{{$type}}" type="text" >
                                                                @else
                                                                    <input  class="form-control"  disabled  value="Postpaid" required type="text" >
                                                                    <input class="input" hidden="true" name="type" value="{{$type}}" type="text" >
                                                                @endif

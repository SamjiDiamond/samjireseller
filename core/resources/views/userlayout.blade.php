          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#navbar-examples1" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples1">
                ...
                <span class="nav-link-text text-dark">Pay Bills</span>
              </a>
              <div class="collapse" id="navbar-examples1">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{route('user.airtime')}}" class="nav-link">Airtime</a>
                  </li>
                 <li class="nav-item">
                    <a href="{{route('user.internet')}}" class="nav-link">Internet Data</a>
                  </li>
                 <li class="nav-item">
                    <a href="{{route('user.cabletv')}}" class="nav-link">Cable TV</a>
                  </li>
                 <li class="nav-item">
                    <a href="{{route('user.utilitybill')}}" class="nav-link">Utility Bills</a>
                  </li>
                </ul>
              </div>
            </li>

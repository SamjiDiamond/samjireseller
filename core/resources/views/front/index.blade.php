            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="promo-mockup mockup-mobile wow soneFadeUp" data-wow-delay="0.6s">
                        <img class="mockup-mobile-img-1" alt="" src="{{url('./')}}/asset/images/{{$ui->s9_image}}">
                    </div>
                    <!-- /.promo-mockup -->
                </div>
                <!-- /.col-lg-6 -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="editure-feature-image">
                    <div class="image-one">
                        <img src="{{url('/')}}/asset/images/{{$ui->s4_image}}" class="wow soneFadeRight r10" data-wow-delay="0.3s" alt="feature-image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
